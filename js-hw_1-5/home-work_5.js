...
// Клас очікує тільки один аргумент - початковий масив товарів, який записується
// у властивість items об'єкта, що створюється.
...
// VERSION_2__________________________________
// class Storage {
//     constructor(items) {
//         this.items = items;
//     }
...
// початок значення властивості value об'єкта, який викликає цей метод.
// padBoth(str) - отримує параметр str (рядок) і додає його на початок і
// в кінець значення властивості value об'єкта, який викликає цей метод.
...
// ___VERSION_2_________________________________-
// class StringBuilder {
//     constructor(initialValue) {
//         this.value = initialValue;
//     }
